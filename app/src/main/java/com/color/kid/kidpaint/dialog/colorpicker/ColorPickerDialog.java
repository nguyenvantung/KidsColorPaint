...
package com.color.kid.kidpaint.dialog.colorpicker;
...
import com.color.kid.kidpaint.dialog.BaseDialog;
...
public final class ColorPickerDialog extends BaseDialog {
	...
	private ColorPickerDialog(Context context) {
		super(context);
		mOnColorPickedListener = new ArrayList<OnColorPickedListener>();
	}
    ...
    private void updateColorChange(int color) {
        ArrayList<OnColorPickedListener> itemsToRemoveFromList = new ArrayList<OnColorPickedListener>();
