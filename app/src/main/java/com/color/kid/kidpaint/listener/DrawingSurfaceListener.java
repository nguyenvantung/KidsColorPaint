...
package com.color.kid.kidpaint.listener;
...
//	private MoveThread moveThread;
    ...
    public boolean onTouch(View view, MotionEvent event) {
        PointF touchPoint = mPerspective.getCanvasPointFromSurfacePoint(new PointF(event.getX(), event.getY()));
            ...
            case MotionEvent.ACTION_CANCEL:
                if (mTouchMode == TouchMode.DRAW) {
                    ...
                    PaintroidApplication.currentTool
                            .resetInternalState(Tool.StateChange.MOVE_CANCELED);
                }
                mPointerDistance = 0;
