...
import com.color.kid.kidpaint.command.implementation.BaseCommand;
...
import static com.color.kid.kidpaint.ui.TopBar.ToolButtonIDs.BUTTON_ID_TOOL;
...
public abstract class BaseTool extends Observable implements Tool, Observer {
	...
	private BrushPickerDialog.OnBrushChangedListener mStroke;
	protected ColorPickerDialog.OnColorPickedListener mColor;
	...
	public BaseTool(Context context, ToolType toolType) {
		...
		mStroke = new BrushPickerDialog.OnBrushChangedListener() {
			@Override
