...
import com.color.kid.kidpaint.activity.OptionsActivity;
import com.color.kid.kidpaint.activity.PaintroidApplication;
import com.color.kid.kidpaint.command.UndoRedoManager;
...
public class TopBar extends Observable implements OnTouchListener {
	...
	private static final int SWITCH_TOOL_TOAST_Y_OFFSET = (int) OptionsActivity.ACTION_BAR_HEIGHT + 25;
